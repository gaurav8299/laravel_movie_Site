    ...
    <header class="text-slate-50 body-font bg-black ">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl text-white">Gaurav & LPU Cinema</span>
          </a>
          ...
          <footer class="text-gray-600 body-font">
              <div class="container px-5  mx-auto flex items-center sm:flex-row flex-col">
                <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                  ...
                  <span class="ml-3 text-xl">Gaurav</span>
                </a>
                <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 Gaurav —
                  <a href="" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@LPU Cinema</a>
                </p>
